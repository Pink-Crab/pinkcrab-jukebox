<?php
/**
 * Jukebox block template.
 *
 * @var string $block_id      Unique block ID.
 * @var string $style_vars    Inline CSS custom properties.
 * @var string $tracks_json   JSON-encoded tracks array.
 * @var array  $tracks        Sanitized tracks array.
 * @var bool   $show_filter   Whether to show the filter input.
 * @var bool   $show_tracklist Whether to show the tracklist.
 *
...
<div
	...
	tabindex="0"
	role="region"
	aria-label="<?php esc_attr_e( 'Audio jukebox player', 'pinkcrab-jukebox' ); ?>"
>
	<!-- Player Section -->
	<div class="jukebox__player">
		...
		<aside class="jukebox__sidebar">
			...
			<button
				type="button"
				class="jukebox__sidebar-btn jukebox__shortcuts-toggle"
				aria-label="<?php esc_attr_e( 'Keyboard shortcuts', 'pinkcrab-jukebox' ); ?>"
				title="<?php esc_attr_e( 'Keyboard shortcuts (?)', 'pinkcrab-jukebox' ); ?>"
			>
				<svg viewBox="0 0 24 24" fill="currentColor">
	...
	<div class="jukebox__queue jukebox__queue--hidden">
		...
		<ul class="jukebox__queue-list" role="list">
			<!-- Queue items added by JS -->
		</ul>
	</div>

	<!-- Screen reader announcements -->
	<div class="jukebox__sr-announce" aria-live="polite" aria-atomic="true" style="position:absolute;width:1px;height:1px;padding:0;margin:-1px;overflow:hidden;clip:rect(0,0,0,0);white-space:nowrap;border:0;"></div>
